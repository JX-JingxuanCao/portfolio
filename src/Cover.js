...
const svgResource = new Promise((resolve) =>
  new loader().load(
    "https://raw.githubusercontent.com/drcmda/react-three-fiber/master/examples/resources/images/svg/night.svg",
    (shapes) =>
      resolve(
        flatten(
